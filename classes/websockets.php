...
abstract class WebSocketServer {
	...
	public $monitor_values = array();
	public $control_values = array();
	...
	abstract protected function loop(); // Process that should happen periodically.  Will happen at least once per second, but possibly more often.
	//abstract protected function loop_per_user($user); // Process that should happen periodically.  Will happen at least once per second, but possibly more often.
	...
	public function getColoredString($string, $foreground_color = null, $background_color = null) {
		...
		return date('d.m.Y H:i:s').": ".$colored_string."\n";
	}
	...
	public function sendById($userId, $message) {
